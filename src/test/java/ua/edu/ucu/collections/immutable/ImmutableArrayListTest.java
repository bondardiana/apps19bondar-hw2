...
public class ImmutableArrayListTest {
    ...
    public void testImmutableArrayLListWithEls() {
      ...
      newArrayLList2=newArrayLList2.add(1,t[0]);
        newArrayLList2=newArrayLList2.add(1,t[1]);
...
//        newArrayLList2= newArrayLList2.clear();
        assertNull(newArrayLList2.elements[0]);
        assertEquals(newArrayLList2.isEmpty(), true);
        assertEquals(newArrayLList2.size(), 0);
